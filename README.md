...
1. В директории проекта выполните команду:
   python3 main.py     
2. Подайте на вход название проверяемого файла: (Файл для проверки должен находиться в директории проекта, иначе следует подать абсолютный путь во избежание путаницы.)
    test_data.txt
